...
public:
    inline RedisBuffer();
    inline RedisBuffer(const void *ptr, size_t dataSize);
...
RedisBuffer::RedisBuffer(const void *ptr, size_t dataSize)
    : ptr_(reinterpret_cast<const char*>(ptr)), size_(dataSize)
{
